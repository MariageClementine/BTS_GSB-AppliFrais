...
--
-- Host: localhost    Database: appliFrais
-- ------------------------------------------------------
...
--
-- Current Database: `appliFrais`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `appliFrais` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `FicheFrais` (
  ...
  KEY `fk_bd61889c-ba62-11e3-8d58-080027274fe6` (`idEtat`),
  CONSTRAINT `fk_bd61889c-ba62-11e3-8d58-080027274fe6` FOREIGN KEY (`idEtat`) REFERENCES `Etat` (`id`),
  CONSTRAINT `fk_bd618e1e-ba62-11e3-8d58-080027274fe6` FOREIGN KEY (`idVisiteur`) REFERENCES `Visiteur` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `FicheFrais` VALUES ('a55','201404',4,NULL,'2014-04-08','CL'),('a55','201406',0,NULL,'2014-06-06','CR');
...
CREATE TABLE `LigneFraisForfait` (
  ...
  KEY `fk_bd620812-ba62-11e3-8d58-080027274fe6` (`idFraisForfait`),
  KEY `fk_LigneFraisForfait_Visiteur1_idx` (`idVisiteur`),
  CONSTRAINT `fk_bd6203c6-ba62-11e3-8d58-080027274fe6` FOREIGN KEY (`idVisiteur`, `mois`) REFERENCES `FicheFrais` (`idVisiteur`, `mois`),
  CONSTRAINT `fk_bd620812-ba62-11e3-8d58-080027274fe6` FOREIGN KEY (`idFraisForfait`) REFERENCES `FraisForfait` (`id`),
  CONSTRAINT `fk_LigneFraisForfait_Visiteur1` FOREIGN KEY (`idVisiteur`) REFERENCES `Visiteur` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `LigneFraisForfait` VALUES ('a55','201404','ETP',10),('a55','201404','KM',12),('a55','201404','NUI',2),('a55','201404','REP',24),('a55','201406','ETP',10),('a55','201406','KM',30),('a55','201406','NUI',2),('a55','201406','REP',2);
...
CREATE TABLE `LigneFraisHorsForfait` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_bd626dd4-ba62-11e3-8d58-080027274fe6` (`idVisiteur`,`mois`),
  KEY `fk_LigneFraisHorsForfait_Visiteur1_idx` (`idVisiteur`),
  CONSTRAINT `fk_bd626dd4-ba62-11e3-8d58-080027274fe6` FOREIGN KEY (`idVisiteur`, `mois`) REFERENCES `FicheFrais` (`idVisiteur`, `mois`),
  CONSTRAINT `fk_LigneFraisHorsForfait_Visiteur1` FOREIGN KEY (`idVisiteur`) REFERENCES `Visiteur` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `LigneFraisHorsForfait` VALUES (1,'a55','201404','chewing-gum','2014-01-12','1.00',1),(3,'a55','201404','bristol','2014-01-12','3.00',1);
...
-- Dump completed on 2014-06-06 23:00:45
